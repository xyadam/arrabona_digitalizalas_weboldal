...
window.LANG_OCR_EN = {
  ...
  "mukodes.03": "We use AI to extract book details from digital images. Recognised works are automatically matched in major library catalogues and enriched with official USMARC data.",
  ...
  "mukodes.17": "USMARC enrichment",
  "mukodes.18": "We match each recognised book in major library catalogues and add official USMARC data to its record.",
  ...
  "mukodes.13": "Enlarge: catalogue cards, digitisation, AI data extraction, USMARC enrichment and searchable catalogue",
  "mukodes.14": "Catalogue cards, digitisation, AI data extraction, USMARC enrichment and searchable catalogue",
